    ...
    <div class="row ">
        <div class=" col-7 ">
            ...
            <div class="row justify-content-center">
                <div class="col-8">
                    <select class="form-select form-select-lg mt-3 " v-model="selectedPage">
                        <!-- 動態生成的分頁選項 -->
                        <option value="無" v-if="bookData.length==0">無</option>
            ...
            <div class="d-flex justify-content-center">
                <table class="table table-bordered text-center mt-3" style="width: 95%;">
        ...
        <div class=" col-5" style="background-color:rgb(240, 238, 235); height:95vh; position: relative;">
